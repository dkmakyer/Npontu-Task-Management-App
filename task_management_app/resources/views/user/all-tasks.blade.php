    ...
    <body class="bg-gray-100 font-sans">
        ...
        <div class="flex h-screen pt-16">
            ...
            <div class="w-[70%]">
                ...
                <div
                    class="flex-1 p-6 flex space-x-6 border border-[2px] border-gray-200 absolute left-[19rem] top-[10rem]">
                                    ...
                                    @else
                                        <div class="flex justify-center items-center mb-4">
                                            <h2 class="text-[13px] flex flex-row items-center gap-4">
                                                <span class="text-red-400 text-[20px]">You have no tasks in the system under
                                                    this category
                                                </span>
                                            </h2>
                                        </div>
                    ...
                    <div class="w-1/2 bg-white p-4 rounded shadow">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-[13px] flex flex-row gap-4"><i
                                    class="fa-solid fa-clipboard-check text-[20px]"></i><span class="text-red-400">Completed
                                    Tasks</span></h2>
                        </div>
                            ...
                            @if (session('filteredCompletedTasks'))
                                ...
                                @else
                                    <div class="flex justify-center items-center mb-4">
                                        <h2 class="text-[13px] flex flex-row items-center gap-4"><i
                                                class="fa-solid fa-clipboard-check text-[24px]"></i><span
                                                class="text-red-400 text-[20px]">You have no completed tasks under this
                                                category in the
                                                system</span>
                                        </h2>
                                    </div>
